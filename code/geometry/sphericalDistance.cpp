...
with azimuthal angles (longitude) f1 and f2 from x axis and zenith angles (latitude)
...
you have you can use only the two last rows. dx*radius is then the difference between
the two points in the x direction and d*radius is the total distance between the points.
*/
